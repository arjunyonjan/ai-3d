(function() {
  ...
  data.nodes.forEach(function(n, i) {
    ...
    var ringSvg = isCore
      ? '<div class="core-ring-wrap" style="position:absolute;top:50%;left:50%;width:120px;height:120px;transform:translate(-50%,-50%);pointer-events:none">'
        + '<svg class="cr-r1" width="120" height="120" viewBox="0 0 100 100" style="position:absolute;top:0;left:0"><circle cx="50" cy="50" r="46" fill="none" stroke="#00ffa0" stroke-width="0.4" opacity="0.3"/></svg>'
        + '<svg class="cr-r2" width="120" height="120" viewBox="0 0 100 100" style="position:absolute;top:0;left:0"><circle cx="50" cy="50" r="42" fill="none" stroke="#00ffa0" stroke-width="0.3" opacity="0.2" stroke-dasharray="8 14"/><circle cx="50" cy="50" r="38" fill="none" stroke="#00ffa0" stroke-width="0.35" opacity="0.15" stroke-dasharray="3 9"/></svg>'
        + '<svg class="cr-r3" width="120" height="120" viewBox="0 0 100 100" style="position:absolute;top:0;left:0"><circle cx="50" cy="50" r="34" fill="none" stroke="#00ffa0" stroke-width="0.25" opacity="0.4" stroke-dasharray="2 4"/><circle cx="50" cy="50" r="30" fill="none" stroke="#00ffa0" stroke-width="0.3" opacity="0.2" stroke-dasharray="12 8"/></svg>'
        + '<svg class="cr-cross" width="120" height="120" viewBox="0 0 100 100" style="position:absolute;top:0;left:0"><line x1="8" y1="50" x2="18" y2="50" stroke="#00ffa0" stroke-width="0.5" opacity="0.5"/><line x1="82" y1="50" x2="92" y2="50" stroke="#00ffa0" stroke-width="0.5" opacity="0.5"/><line x1="50" y1="8" x2="50" y2="18" stroke="#00ffa0" stroke-width="0.5" opacity="0.5"/><line x1="50" y1="82" x2="50" y2="92" stroke="#00ffa0" stroke-width="0.5" opacity="0.5"/><line x1="50" y1="50" x2="65" y2="28" stroke="#00ffa0" stroke-width="0.3" opacity="0.15"/><line x1="50" y1="50" x2="72" y2="50" stroke="#00ffa0" stroke-width="0.3" opacity="0.15"/><line x1="50" y1="50" x2="50" y2="72" stroke="#00ffa0" stroke-width="0.3" opacity="0.15"/></svg>'
        + '<svg class="cr-scan" width="120" height="120" viewBox="0 0 100 100" style="position:absolute;top:0;left:0"><path d="M50,50 L50,6 A44,44 0 0,1 94,50" fill="none" stroke="#00ffa0" stroke-width="0.8" opacity="0.5"/></svg>'
        + '<svg class="cr-pulse" width="120" height="120" viewBox="0 0 100 100" style="position:absolute;top:0;left:0"><circle cx="50" cy="50" r="20" fill="none" stroke="#00ffa0" stroke-width="0.2" opacity="0.3"/><circle cx="50" cy="50" r="12" fill="none" stroke="#00ffa0" stroke-width="0.2" opacity="0.2"/><circle cx="50" cy="50" r="4" fill="#00ffa0" opacity="0.15"/></svg>'
        + '</div>'
      : '';
